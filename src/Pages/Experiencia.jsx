            ...
            <div className="backplane">
                <div className="steps">
                    <div className="concluido step">
                        ...
                        <div className="linha concluido"></div>
                ...
                <div className="input-group">
                    ...
                    <div className="div-input">
                        <label htmlFor="tempo">Tempo de Serviço:</label>
                        <Input type="text" name="tempo"/>
                    </div>
                    <div className="div-input">
                        <label >É seu emprego atual?</label>
                        Sim<input type="radio" name="emprego" id="" />
                        Não<input type="radio" name="emprego" id="" />
                    </div>
                </div>
                </form>
                <footer>
                    <GreyButton className="grey small-button animado" label="Voltar"/>
                    <RedButton  className="red small-button animado" label="Avançar"/>
                </footer>
            </div>
        )
    }
